...
export const Header: React.FC = () => {
  ...
  return (
   <header className="flex items-center justify-between whitespace-nowrap border-b border-white/5 bg-[#0f172a]/70 backdrop-blur-xl px-6 sm:px-10 py-4 sticky top-0 z-50 transition-all duration-300">
        ...
        <div className="hidden lg:flex items-center gap-8">
          <nav className="flex items-center gap-1 bg-slate-900/50 p-1 rounded-full border border-white/5 backdrop-blur-sm">
            ...
            <a className="px-5 py-2 rounded-full text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800/50 transition-all" href="#">Sell</a>
          ...
          <div className="flex gap-3">
            <button className="relative group flex items-center justify-center overflow-hidden rounded-full h-10 w-10 bg-slate-800 border border-white/5 text-slate-300 hover:border-primary hover:text-primary hover:shadow-glow-sm transition-all duration-300">
              <span className="group-hover:scale-110 transition-transform">
                <img src={ShoppingCartIcon} alt="Cart" width={24} height={24} />
              </span>
              <span className="absolute top-0 right-0 h-2.5 w-2.5 bg-red-500 rounded-full border-2 border-[#0f172a]"></span>
            </button>
              <Link to="/login">
                <button className="group flex items-center justify-center overflow-hidden rounded-full h-10 w-10 bg-slate-800 border border-white/5 text-slate-300 hover:border-primary hover:text-primary hover:shadow-glow-sm transition-all duration-300">
                  <span className="group-hover:scale-110 transition-transform">
                    <img src={AccountCircleIcon} alt="Account" width={24} height={24} />
                  </span>
                </button>
              </Link>
          </div>
