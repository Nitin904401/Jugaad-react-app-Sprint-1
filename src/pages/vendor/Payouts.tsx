  ...
  return (
    <div className="flex h-screen w-full bg-background-dark text-white font-display overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-[#1a2332] via-[#0f1923] to-[#0f1923]">
        {/* Header */}
        <header className="glass-header w-full px-8 py-4 flex items-center justify-between border-b border-white/10">
          <div className="flex items-center gap-2 text-sm">
            <a className="text-[#9babbb] hover:text-white" href="#">Home</a>
            <span className="text-[#556475] material-symbols-outlined text-[16px]">chevron_right</span>
            <a className="text-[#9babbb] hover:text-white" href="#">Finance</a>
            <span className="text-[#556475] material-symbols-outlined text-[16px]">chevron_right</span>
            <span className="text-white font-medium">Payout History</span>
          </div>

          <div className="flex items-center gap-4">
            <button className="relative w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#27303a] text-[#9babbb] hover:text-white">
              <span className="material-symbols-outlined">notifications</span>
              <span className="absolute top-0 right-0 h-2 w-2 rounded-full bg-red-500 border-2 border-[#111418]"></span>
            </button>
            <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#27303a] text-[#9babbb] hover:text-white">
