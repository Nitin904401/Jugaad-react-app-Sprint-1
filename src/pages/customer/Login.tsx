    ...
    <>
      <form onSubmit={handleSubmit} className="p-6 sm:p-8 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <button type="button" className="flex w-full items-center justify-center h-12 rounded-xl bg-slate-800 border border-slate-700 text-white font-bold text-sm hover:bg-slate-700 hover:border-slate-600 shadow-sm transform transition-all duration-300 hover:-translate-y-0.5 active:scale-95">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button type="button" className="flex items-center justify-center gap-2 h-11 rounded-xl border border-slate-700 bg-slate-800 text-sm font-semibold hover:bg-slate-700 text-white shadow-sm hover:shadow transition-all transform duration-300 hover:-translate-y-0.5 active:scale-95">
            {/* Google logo */}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setModal({
        ...
        message: "Your account has been created successfully. You will be logged in automatically.",
      });
      ...
      const message = err.message.includes("Email already exists")
